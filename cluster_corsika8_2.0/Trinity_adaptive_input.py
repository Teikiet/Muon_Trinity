...
def generate_energy_strings():
    ...
    energies = energies[(energies >= 1e4) & (energies <= 1.2e4)]
    return [to_1e(e) for e in energies]


def main():
    parser = argparse.ArgumentParser(
        description="Generate adaptive simulation inputs for Trinity runs."
    )
    ...
    data = {
        ...
        "adaptive_defaults": {
            ...
            "max_queued": 900,
            "save_batches": 100,
            "h_values": [3500, 5000, 7000, 9000, 12000, 15000, 15000, 20000],
        },
    }
