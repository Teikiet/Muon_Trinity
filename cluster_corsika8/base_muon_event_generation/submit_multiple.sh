...
ZENITHS=(89.9 89 88 87)                  # zenith angles in deg 89.9 89 88 87 
AZIMUTHS=(268 269 270 271 272)                # azimuth angles in degrees 267 268 269 270 271 272 273
TEL_XS=(0) # telescope x positions in meters
TEL_ZS=(0) # telescope z positions in meters
INJ_HEIGHTS=(5000 10000 15000 20000 30000)  # injection heights in meters 5000 10000 15000 20000
SEEDS=(9 10)                     # random seeds
